...
enum Reminders {
    private static let identifier = "allowance.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "How are your envelopes doing?"
        content.body = "Check your balances and log any spends to stay on budget."
